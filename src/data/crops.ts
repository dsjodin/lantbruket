...
export const CROPS_DATA: Record<CropType, CropData> = {
  [CropType.Hostvete]: {
    ...
    baseYieldPerHa: 7.5,
    seedCostPerHa: 1150,
    fertilizerCostPerHa: 3400,
    harvestCostPerHa: 2700,
  ...
  [CropType.Potatis]: {
    ...
    baseYieldPerHa: 35.0,
    seedCostPerHa: 15000,
    fertilizerCostPerHa: 4500,
    harvestCostPerHa: 5500,
    plantQuarter: Quarter.Var,
    harvestQuarter: Quarter.Host,
    growingSeasons: 2,
    spoilageRate: 0.05,
  ...
  [CropType.Varvete]: {
    ...
    baseYieldPerHa: 5.5,
    seedCostPerHa: 1100,
    fertilizerCostPerHa: 2800,
    harvestCostPerHa: 2400,
    plantQuarter: Quarter.Var,
    harvestQuarter: Quarter.Host,
    growingSeasons: 2,
    spoilageRate: 0.01,
