...
const steps = ["Gårdsnamn", "Region", "Storlek", "Startkapital", "Sammanfattning"];
...
export default function NyGardPage() {
  ...
  const canNext = () => {
    if (step === 0) return playerName.trim() !== "" && farmName.trim() !== "";
    return true;
  };
        ...
        <Card className="max-w-lg mx-auto">
          ...
          {step === 0 && (
            <div className="space-y-4">
              <h2 className="text-xl font-semibold">Vad heter du och din gård?</h2>
              <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex justify-between text-xs text-stone-400">
                  <span>20 ha (liten)</span>
                  <span>500 ha (stor)</span>
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-stone-600 mb-1">
